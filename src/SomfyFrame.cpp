...
// RTS frame codec, split out of Somfy.cpp: command translation and the
// somfy_frame_t encode/decode/repeat logic.  Bit-level primitives live in
// SomfyCodec.cpp; the one radio dependency left here is the RSSI read at
// decode time.  Declarations stay in Transceiver.h.
